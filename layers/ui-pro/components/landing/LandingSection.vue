<template>
  ...
  >
    ...
    <UContainer :class="ui.container">
      <div
        v-if="(icon || $slots.icon) || (headline || $slots.headline) || (title || $slots.title) || (description || $slots.description) || (links?.length || $slots.links)"
        :class="ui.base"
      >
        <div
        ...
        <div
          v-else-if="headline || $slots.headline"
          :class="ui.headline"
        >
          <slot name="headline">
            {{ headline }}
