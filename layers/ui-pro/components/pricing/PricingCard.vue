        ...
        >
          <slot name="features">
            <ul
              ...
              :class="ui.features.horizontal"
            >
              <li
                v-for="(offer, index) of features"
                :key="index"
                :class="ui.features.item.base"
              >
                <UIcon
                  :name="ui.features.item.icon.name"
                  :class="ui.features.item.icon.base"
                />
